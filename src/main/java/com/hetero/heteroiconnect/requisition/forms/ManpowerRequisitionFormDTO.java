...
public class ManpowerRequisitionFormDTO {
	...
	public String getReqJobDescription() {
		return reqJobDescription;
	}

	public void setReqJobDescription(String reqJobDescription) {
		this.reqJobDescription = reqJobDescription;
	}
	...
	public String getDeptHeadSign() {
		return deptHeadSign;
	}

	public void setDeptHeadSign(String deptHeadSign) {
		this.deptHeadSign = deptHeadSign;
	}
	...
	public String getDeptHeadDate() {
		return deptHeadDate;
	}

	public void setDeptHeadDate(String deptHeadDate) {
		this.deptHeadDate = deptHeadDate;
	}

	public String getUnitHeadSign() {
		return unitHeadSign;
	}

	public void setUnitHeadSign(String unitHeadSign) {
		this.unitHeadSign = unitHeadSign;
	}
	...
	public String getUnitHeadDate() {
		return unitHeadDate;
	}

	public void setUnitHeadDate(String unitHeadDate) {
		this.unitHeadDate = unitHeadDate;
	}
	...
	public String getReplacedQualification() {
		return replacedQualification;
	}

	public void setReplacedQualification(String replacedQualification) {
		this.replacedQualification = replacedQualification;
	}
