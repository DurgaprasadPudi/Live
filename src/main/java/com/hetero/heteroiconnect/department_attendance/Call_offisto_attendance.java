...
import com.hetero.heteroiconnect.classes.Attenance_backup;

import net.sf.json.JSONArray;
import net.sf.json.JSONObject;
 
@Repository
public class Call_offisto_attendance {
...
//	              		    	}
	              			...
	              			Main.put("ID",username);
	              			Main.put("NAME",Callname);
              		    	if(isManager.equalsIgnoreCase("1")){
              		    		Main.put("isManager"," ");
              		    	}else{
              		    		Main.put("isManager","none");
              		    	}
	              			
	              			//Main.compute(key, remappingFunction);
              		    	
              		    	Main.put("dates", Daily_30day);
	              			
	              			
	              			mp.put("ATT_DATA", Main);
